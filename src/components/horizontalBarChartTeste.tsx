...
// export default function HorizontalBarChartTeste() {
...
export default function HorizontalBarChartTeste(props: HorizontalBarChartProps) {
  const { label, data, style, chartColor } = props
  const chartRef = useRef<HTMLCanvasElement>(null);
      ...
      const options: ChartOptions = {
        ...
        scales: {
          y: {
            ...
            ticks: {
              stepSize: 10,
              padding: 20, // Espaçamento extra para os labels
            },
          },
          x: {
            ticks: {
        ...
        plugins: {
          ...
          tooltip: {
            ...
            cornerRadius: 5, // Arredondamento do tooltip
            padding: 10, // Espaçamento interno
            shadowOffsetX: 2, // Sombra no eixo X
            shadowOffsetY: 2, // Sombra no eixo Y
            shadowBlur: 10, // Grau de desfoque da sombra
